  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10 bg-gradient-to-br from-sky-100 via-blue-50 to-indigo-100">
      <motion.div
        ...
        className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-blue-300/30 blur-[80px]"
      />
      <motion.div
        ...
        className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-cyan-200/40 blur-[100px]"
      />
      <motion.div
        ...
        className="absolute top-[40%] left-[60%] w-[30vw] h-[30vw] rounded-full bg-indigo-200/30 blur-[70px]"
      />
    </div>
  );
}
  ...
  return (
    <main className="min-h-screen relative overflow-hidden text-slate-800">
      ...
      <AnimatePresence mode="wait">
        {phase === 1 && (
          <Phase1Runaway key="phase1" onNext={() => setPhase(2)} />
        )}
        {phase === 2 && (
          <Phase2Balloons key="phase2" onNext={() => setPhase(3)} />
        )}
...
function RealisticCake({
 ...
 const handleActivate = (
  ...
  return (
    <motion.div
      animate={
        isBlown ? { y: [0, -16, 0, -8, 0], scale: [1, 1.04, 1] } : { y: 0 }
      }
...
function BalloonItem({
  ...
  const { id, x, delay, duration, swayDuration, size, isSpecial, color } =
    balloon;
...
export function Phase3MainContent() {
  ...
  const photos = [
    {
      id: 1,
      src: "https://images.unsplash.com/photo-1518199268815-95a206069e47?auto=format&fit=crop&w=600&q=80",
      cap: "Awal Ketemu 💙",
      detail:
        "Inget gak pas pertama kali kita ketemu? Keliatan malu-malu tapi aslinya... hahahaha.",
      rot: -8,
      top: "5%",
      left: "5%",
    },
    {
      ...
      cap: "Ngedate Perdana",
      detail:
        "Jalan bareng pertama kali. Rasanya deg-degan tapi seneng banget bisa abisin waktu sama kamu.",
      rot: 6,
      top: "10%",
      left: "50%",
    },
    {
      ...
      cap: "Muka Ngambek 😤",
      detail:
        "Ini muka kamu pas lagi bete. Sumpah lucu banget, makanya sering aku isengin wkwk.",
      rot: -4,
      top: "35%",
      left: "15%",
    },
    {
      ...
      cap: "Random Selfie",
      detail:
        "Lagi di jalan tiba-tiba minta foto. Hasilnya tetep cantik kok, santai aja.",
      rot: 10,
      top: "40%",
      left: "55%",
    },
    {
      ...
      cap: "Makan Terus 🍜",
      detail:
        "Nih bukti nyata hobi kita: Cari makan! Gak apa-apa, yang penting bahagia kan?",
      rot: -12,
      top: "65%",
      left: "5%",
    },
    {
      id: 6,
      src: "https://images.unsplash.com/photo-1541250848049-b4f71461741b?auto=format&fit=crop&w=600&q=80",
      cap: "Tidur Siang 😴",
      detail:
        "Diam-diam difoto pas lagi pules. Muka capek abis jalan-jalan seharian.",
      rot: 5,
      top: "60%",
      left: "60%",
    },
    {
      ...
      cap: "Happy Birthday! 🎂",
      detail:
        "Hari ini spesial buat kamu. Semoga doa-doa baik terkabul yaa. Amin!",
      rot: -5,
      top: "25%",
      left: "35%",
    },
  ...
  return (
    <>
      <motion.div
        ...
        className="w-full min-h-screen py-20 px-4 md:px-8 relative z-10"
      >
        <div className="max-w-5xl mx-auto space-y-32">
          <section>
            <div className="text-center mb-16 relative z-20">
              <h2 className="font-heading text-4xl md:text-5xl text-blue-700 drop-shadow-sm">
                Memory Lane 📸
              </h2>
              <p className="text-slate-600 mt-4 text-lg bg-white/40 inline-block px-6 py-2 rounded-full backdrop-blur-sm">
                Geser fotonya, atau KLIK buat liat detailnya!
              </p>
            </div>

            <div
              ref={containerRef}
              className="relative h-[80vh] bg-white/20 backdrop-blur-xl rounded-[3rem] border-4 border-dashed border-white/60 shadow-lg p-4 overflow-hidden"
            >
              {photos.map((p) => (
                <PolaroidCard
                  key={p.id}
        ...
        {selectedPhoto && (
          ...
          >
            <motion.div
              ...
              className="bg-white p-5 pb-7 md:p-8 md:pb-10 rounded-3xl shadow-2xl max-w-sm md:max-w-md w-full relative flex flex-col items-center"
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <h3 className="font-heading text-2xl md:text-3xl text-slate-800 mb-3 w-full text-center">
                    {selectedPhoto.cap}
                  </h3>
                  <div className="h-1 w-12 bg-blue-300 mb-5 rounded-full opacity-60" />
                  <p
                    className="text-slate-600 leading-relaxed text-base text-center px-2"
                    style={{ fontFamily: "var(--font-sans)" }}
                  >
                    {selectedPhoto.detail}
                  </p>
                  <p className="text-xs text-slate-400 mt-4">
                    Geser foto untuk pindah &middot; {currentIndex + 1} /{" "}
                    {photos.length}
                  </p>
                </motion.div>
              </AnimatePresence>
    ...
    >
      ...
      <div className="bg-slate-100 w-full aspect-square mb-3 overflow-hidden shadow-inner border border-slate-100 pointer-events-none">
        <img
          src={photo.src}
          alt="memory"
          className="object-cover w-full h-full grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-500 pointer-events-none"
        />
      </div>
      <p className="font-heading text-center text-slate-700 text-sm md:text-base pointer-events-none">
        {photo.cap}
      </p>
    </motion.div>
  );
...
function GachaBox() {
  const [phase, setPhase] = useState<"idle" | "shaking" | "opening" | "result">(
    "idle",
  );
  ...
  return (
    <div className="bg-white/40 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 shadow-2xl max-w-lg mx-auto text-center border-2 border-white/60 relative overflow-hidden">
      ...
      <h3 className="font-heading text-3xl md:text-4xl text-indigo-600 mb-2 drop-shadow-sm relative z-10">
        Waktunya Gacha! 🎁
      </h3>
      <p className="text-indigo-400 text-sm mb-8 relative z-10">
        Satu kotak, satu hadiah random buat kamu
      </p>
        ...
        {phase !== "result" ? (
          <div className="flex flex-col items-center">
            ...
            <motion.div className="mt-6 bg-white/60 backdrop-blur-sm px-6 py-2 rounded-full shadow-inner border border-white/50 h-10 flex items-center justify-center min-w-[200px]">
              <p
                className={`font-heading ${isShaking ? "text-indigo-400 text-lg animate-pulse" : "text-slate-600 text-xl"}`}
              >
                {isShaking
                  ? shuffleText
                  : phase === "opening"
          ...
          >
            <div className="bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 p-1.5 rounded-2xl shadow-2xl relative">
              ...
              <div className="bg-white rounded-xl border-2 border-dashed border-indigo-200 p-6 md:p-8 relative overflow-hidden flex flex-col items-center">
                <Ticket
                  className="absolute -right-8 -bottom-8 text-indigo-50 opacity-50 rotate-[-15deg]"
                  size={150}
                />
                <div className="flex items-center gap-2 mb-4">
                  <Sparkles className="text-amber-400" size={24} />
                  <p className="font-heading text-indigo-400 tracking-widest text-sm uppercase">
                    Official Voucher
                  </p>
                  <Sparkles className="text-amber-400" size={24} />
                </div>
                <h4 className="text-slate-500 mb-2 font-medium">
                  Selamat! Kamu dapet:
                </h4>
...
export function FooterLoveLetter() {
  ...
  return (
    <footer
      ref={ref}
      className="relative pt-24 pb-32 flex flex-col items-center"
    >
      <style
      ...
      >
        <div className="text-center mb-12">
          <h2 className="font-heading text-3xl md:text-4xl text-indigo-600 drop-shadow-sm">
            Ada Pesan Terakhir Nih 💌
          </h2>
          <p className="text-slate-500 mt-2 font-medium bg-white/50 px-4 py-1 rounded-full inline-block">
            Klik amplopnya ya!
          </p>
        </div>

        <div
          className="relative w-80 md:w-[26rem] h-56 md:h-64 cursor-pointer group"
          onClick={handleOpen}
        >
          ...
          >
            <Heart
              ...
              fill="currentColor"
            />
            <p className="font-typewriter text-sm text-slate-400">
              To: Aini...
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="bg-white rounded-lg p-10 flex flex-col items-center relative overflow-hidden flex-grow">
                ...
                <Heart
                  className="text-red-400 mb-10 mx-auto mt-4 relative z-10"
                  size={40}
                  fill="currentColor"
                />
                <div
                  className="space-y-[1.75rem] text-slate-700 font-typewriter text-base md:text-xl relative z-10 w-full"
                  style={{ lineHeight: "28px" }}
                >
                  <p>Halo Aini yang (katanya) hari ini lagi nambah umur.</p>
                  <p>
                    Semoga di tanggal 8 Juli ini dan seterusnya, kamu selalu
                    dikasih senyum dan bahagia yang banyak. Makasih udah selalu
                    jadi orang sabar, partner yang asik diajak gila, dan tempat
                    cerita yang paling nyaman.
                  </p>
                  <p>
                    Maaf kalau kadonya nerd banget bentuk web begini wkwk. Tapi
                    sengaja dibikin pake coding biar beda dari yang lain,
                    spesial buat kamu doang.
                  </p>

                  <p>
                    Gua nulis ini panjang-panjang cuma buat ngetes scrollbar
                    doang sebenernya. Bla bla bla. Inget kan waktu itu kita
                    blablabla... pokoknya panjang dah ceritanya gak muat kalau 1
                    paragraf doang.
                  </p>
                  <p>
                    Terus ada lagi pas momen blablabla... panjang banget
                    pokoknya isi hati yang mau disampein.
                  </p>
